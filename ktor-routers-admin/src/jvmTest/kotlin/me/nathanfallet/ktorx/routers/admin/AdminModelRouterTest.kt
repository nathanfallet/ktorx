...
class AdminModelRouterTest {
    ...
    fun testTemplateBasicRoute() = testApplication {
        ...
        val response = client.get("/admin/testmodels/basic")
    ...
    fun testTemplateBasicMapRoute() = testApplication {
        ...
        val response = client.get("/admin/testmodels/basic/map")
        assertEquals(HttpStatusCode.OK, response.status)
        assertEquals(
            TemplateResponse(
                "basic",
    ...
    fun testTemplateBasicModelRoute() = testApplication {
        ...
        val response = client.get("/admin/testmodels/basic/model")
        assertEquals(HttpStatusCode.OK, response.status)
        assertEquals(
            TemplateResponse(
                "basic",
    ...
    fun testTemplateGetCreateRoute() = testApplication {
        ...
        val response = client.get("/admin/testmodels/create")
        assertEquals(HttpStatusCode.OK, response.status)
        assertEquals(
            TemplateResponse(
                "create",
    ...
    fun testTemplatePostCreateRoute() = testApplication {
        ...
        val response = client.post("/admin/testmodels/create") {
    ...
    fun testTemplateGetIdRoute() = testApplication {
        ...
        val response = client.get("/admin/testmodels/1")
        assertEquals(HttpStatusCode.OK, response.status)
        assertEquals(
            TemplateResponse(
                "get",
    ...
    fun testTemplateGetIdUpdateRoute() = testApplication {
        ...
        val response = client.get("/admin/testmodels/1/update")
        assertEquals(HttpStatusCode.OK, response.status)
        assertEquals(
            TemplateResponse(
                "update",
    ...
    fun testTemplatePostIdUpdateRoute() = testApplication {
        ...
        val response = client.post("/admin/testmodels/1/update") {
            contentType(ContentType.Application.FormUrlEncoded)
            setBody(
                listOf(
                    "string" to "string"
    ...
    fun testTemplateGetIdRouteDelete() = testApplication {
        ...
        val response = client.get("/admin/testmodels/1/delete")
        assertEquals(HttpStatusCode.OK, response.status)
        assertEquals(
            TemplateResponse(
                "delete",
    ...
    fun testTemplatePostIdRouteDelete() = testApplication {
        ...
        val response = client.post("/admin/testmodels/1/delete")
        assertEquals(HttpStatusCode.Found, response.status)
