...
class LocalizedAdminChildModelRouterTest {
    ...
    ): LocalizedAdminChildModelRouter<TestModel, Long, TestCreatePayload, TestUpdatePayload, UnitModel, Unit> {
        return LocalizedAdminChildModelRouter(
            typeInfo<TestModel>(),
