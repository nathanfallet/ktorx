...
import io.ktor.util.*
import me.nathanfallet.ktorx.models.health.Check
...
class KtorHealth private constructor(
    ...
    class Configuration internal constructor() {
        ...
        var checks: Map<String, Map<String, Check>> = emptyMap()
            private set
        var noHealth = false
            private set
        var noReady = false
        ...
        fun healthCheck(name: String, check: Check) {
            customCheck("healthz", name, check)
        }
